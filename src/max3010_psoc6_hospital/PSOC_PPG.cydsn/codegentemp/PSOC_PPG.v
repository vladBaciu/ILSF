...
module Scan_ADC_v3_10_3 (
	...
	cy_clock_v1_0
		#(.id("247418ad-1d4f-43ff-b003-074608582178/f7143d07-534d-4542-813a-8bb23ceb1ae9"),
...
// TCPWM_Counter_PDL_v1_0(CaptureInput=7, CaptureInputMasked=3, ClockPrescaler=0, Compare0=16384, Compare1=16384, CompareOrCapture=2, CountDirection=0, CountInput=7, CountInputMasked=3, EnableCompareSwap=false, InterruptSource=1, Period=1000, ReloadInput=7, ReloadInputMasked=3, Resolution=32, RunMode=0, StartInput=7, StartInputMasked=3, StopInput=7, StopInputMasked=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_Counter_PDL_v1_0, CY_CONFIG_TITLE=Timer_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_1, CY_INSTANCE_SHORT_NAME=Timer_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Timer_1, )
...
// TCPWM_Counter_PDL_v1_0(CaptureInput=7, CaptureInputMasked=3, ClockPrescaler=0, Compare0=16384, Compare1=16384, CompareOrCapture=2, CountDirection=0, CountInput=7, CountInputMasked=3, EnableCompareSwap=false, InterruptSource=1, Period=8000, ReloadInput=7, ReloadInputMasked=3, Resolution=32, RunMode=0, StartInput=7, StartInputMasked=3, StopInput=7, StopInputMasked=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_Counter_PDL_v1_0, CY_CONFIG_TITLE=Timer_FillBuffers, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_FillBuffers, CY_INSTANCE_SHORT_NAME=Timer_FillBuffers, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Timer_FillBuffers, )
...
module top ;
    ...
    SCB_I2C_PDL_v2_0_0 I2C_MAX30105 (
        .clock(1'b0),
        .scl_b(Net_8),
        .scl_trig(Net_4),
        .sda_b(Net_9));
	...
	cy_mxs40_gpio_v1_0
		#(.id("171f8054-54a9-4dd7-95e4-b97c8ec3d1c4"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("b7c65549-b401-449c-af60-a8d20865b9e3"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	wire [0:0] tmpFB_0__SDI_net;
	wire [0:0] tmpIO_0__SDI_net;
	electrical [0:0] tmpSIOVREF__SDI_net;

	cy_mxs40_gpio_v1_0
		#(.id("ee74f7a8-f394-485f-9f70-a4c556a65ad0"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
    ...
    Scan_ADC_v3_10_3 ADC_INVERTING_AMP (
        .eos(Net_115),
        .sdone(Net_116),
        .t_chid(Net_117[3:0]),
        .t_chidv(Net_118),
    ...
    TCPWM_Counter_PDL_v1_0_4 Timer_1 (
        .capture(1'b0),
        .clock(Net_57),
        .compare(Net_76),
        .count(1'b1),
	...
	wire [0:0] tmpFB_0__AMP_DIFF_OUTPUT_net;
	wire [0:0] tmpIO_0__AMP_DIFF_OUTPUT_net;
	electrical [0:0] tmpSIOVREF__AMP_DIFF_OUTPUT_net;
	...
	cy_mxs40_gpio_v1_0
		...
		AMP_DIFF_OUTPUT
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__AMP_DIFF_OUTPUT_net[0:0]}),
		  .analog({Net_237}),
		  .io({tmpIO_0__AMP_DIFF_OUTPUT_net[0:0]}),
		  .siovref(tmpSIOVREF__AMP_DIFF_OUTPUT_net));
    ...
    TCPWM_Counter_PDL_v1_0_5 Timer_FillBuffers (
        .capture(1'b0),
        .clock(Net_57),
        .compare(Net_128),
        .count(1'b1),
